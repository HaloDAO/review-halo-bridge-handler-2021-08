...
export default class MintRequestService {
	...
	public async retrieveListOfMintRequests(
		...
		try {
			...
			result = await this._mintRequestRepository.findWithMultipleQueries(
				condQuery,
				pagination,
				orderQuery,
			)
