...
export default class BurnService {
	...
	public async retrieveListOfBurns(
		...
		try {
			...
			result = await this._burnRepository.findWithMultipleQueries(
				condQuery,
				pagination,
				orderQuery,
			)
