...
export default class DepositService {
	...
	public async retrieveListOfDeposits(
		...
		try {
			...
			result = await this._depositRepository.findWithMultipleQueries(
				condQuery,
				pagination,
				orderQuery,
			)
